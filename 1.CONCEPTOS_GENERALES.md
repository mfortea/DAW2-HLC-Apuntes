...
- **Javascript**: Funcionalidad del documento. `ECMAScript6`. (Esta versión es la más importante, está regulada por ECMA, una asociación Europea que realiza estandarizaciones)
...
- **Javascript (Node.js)**: cada vez más popular puesto que se usa también en el lado cliente. (Se integra muy bien con el SGBD MongoDB)
...
- **Javascript**: 
- Existe también TypeScript (de Microsoft) que es como JavaScript pero con tipos de datos.
...
## Modelo-Vista-Controlador
- Es un patrón de diseño bastante usado
...
- Cassandra
- MongoDB (Utiliza JavaScript como lenguaje para comunicarse con la BD)
